      ...
      <div className="container">
        ...
        {cart?.length > 0 ? (
          <>
            ...
            <div className="cart">
              <div className="information-cart mt-7 pt-3 bg-white text-base rounded-lg w-[100%] max-w-[100vw] sm:w-full overflow-x-auto">
              ...
              <div className="information-price bg-white mt-7 text-base rounded-lg flex flex-col self-end justify-start p-3 xl:self-start max-w-[350px]">
